namespace Roomalaiset_numerot
{
    public partial class RoomalainenFM : Form
    {
        ...
        private void muutaBT_Click(object sender, EventArgs e)
        {
            ...
            string vastaus = "";
            if(arvoTB.Text.Length > 3 )//tuhatlukua käsitellään
            {
                ...
                luku4 = Convert.ToInt32(arvoTB.Text.Substring(3,1));//Ykkönen
                if (luku1 % 3 == 0)
                {
                    vastaus += "MMM";
                }
            ...
            else if(arvoTB.Text.Length > 2) //Satalukua käsitellään
            {
